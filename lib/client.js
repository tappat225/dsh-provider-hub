    ...
    selected === null || selectedEntry === void 0 ? null : import_react.default.createElement(
      ...
      import_react.default.createElement(
        ...
        import_react.default.createElement(
          ...
          String((cfg.enabledModels ?? []).length)
        )
      ),
      import_react.default.createElement(
        "div",
        { className: "phub-group" },
        import_react.default.createElement("div", { className: "phub-editor-note", style: { paddingTop: 10 } }, t("builtinHint")),
        import_react.default.createElement(
          "div",
          ...
          Object.entries(state.catalog).map(([id, entry]) => Row({
            key: id,
            title: entry.name,
            desc: import_react.default.createElement("span", { className: "phub-model-params" }, `${entry.contextWindow} · ${entry.maxTokens}`),
            control: SwitchUI({
        ...
        Row({
          title: t("custom"),
          desc: (customRows[selected] ?? []).length === 0 ? t("empty") : void 0,
          control: import_react.default.createElement("button", { className: "phub-btn", onClick: addCustomRow }, `+ ${t("addCustom")}`)
        }),
        (customRows[selected] ?? []).length === 0 ? null : (customRows[selected] ?? []).map(
          (row, rowIndex) => import_react.default.createElement(
            "div",
