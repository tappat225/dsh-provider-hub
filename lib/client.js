...
var zh = {
  ...
  builtinPresetHint: "从内置目录选择模型，参数会自动填入（可修改后再启用）。也支持直接输入任意模型 ID。",
  remove: "移除",
  builtin: "内置目录",
...
var en = {
  ...
  builtinPresetHint: "Pick a curated catalog model — its parameters fill in automatically (editable before enabling). You can also type any model id.",
  remove: "Remove",
  ...
  return import_react.default.createElement(
    ...
    selected === null || selectedEntry === void 0 ? null : import_react.default.createElement(
      ...
      import_react.default.createElement(
        ...
        import_react.default.createElement("div", { className: "phub-editor-note", style: { paddingTop: 10 } }, t("builtinPresetHint")),
        Row({
