...
function ProviderHubPage(props) {
  ...
  const [presetPick, setPresetPick] = import_react.default.useState("");
    ...
    selected === null || selectedEntry === void 0 ? null : import_react.default.createElement(
      ...
      import_react.default.createElement(
        ...
        discovered[selected] === null || discovered[selected] === void 0 ? null : import_react.default.createElement(
          ...
          (discovered[selected] ?? []).length === 0 ? import_react.default.createElement("span", { className: "phub-editor-note", style: { padding: "4px 0" } }, `${t("discovered")}: ${t("empty")}`) : (discovered[selected] ?? []).map((model) => import_react.default.createElement(
            "div",
            ...
            enabledIds.has(model.id) ? import_react.default.createElement("span", { className: "phub-mark" }, t("alreadyEnabled")) : import_react.default.createElement("button", { className: "phub-btn", onClick: () => void enableDiscovered(model) }, t("enable"))
          ))
        ),
        ...
        Row({
          ...
          control: import_react.default.createElement(SelectMenu, {
            ...
            onChange: (next) => {
              setPresetPick(next);
              const entry = next === "" ? void 0 : state.catalog[next];
              setAddModelDraft({
                id: next,
                name: "",
                contextWindow: entry === void 0 ? "" : String(entry.contextWindow),
                maxTokens: entry === void 0 ? "" : String(entry.maxTokens)
              });
            }
          })
        }),
