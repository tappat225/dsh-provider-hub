...
var zh = {
  ...
  providerName: "提供方 ID",
  providerNameHint: "模型选择器中的分组标识；显示名默认跟随其值",
  displayName: "显示名",
  displayNameHint: "默认使用提供方 ID，填写后以填写值为准",
  baseURL: "上游地址",
...
var en = {
  ...
  providerNameHint: "the id that groups models in the model picker; the display name follows it by default",
  displayName: "Display name",
  displayNameHint: "defaults to the provider id; a filled value wins",
  baseURL: "Base URL",
...
function ProviderHubPage(props) {
  ...
  const fieldInput = (key, label, hint, placeholder, wide = false, onChange) => {
    return Field(label, hint, import_react.default.createElement("input", {
      ...
      spellCheck: false,
      onChange: (e) => {
        if (onChange !== void 0) onChange(e.target.value);
  ...
  const editorSection = selected === null || selectedEntry === void 0 ? null : import_react.default.createElement(
    ...
    import_react.default.createElement(
      ...
      import_react.default.createElement(
        "div",
        { className: "phub-form" },
        fieldInput("provider", t("providerName"), t("providerNameHint"), void 0, false, setProviderField),
